    ...
    return room && (
           ...
           {/* Room Images */}
            ...
            {/* CheckIn CheckOut Form*/}
             <form className='flex flex-col md:flex-row items-start md:items-center justify-between
              ...
              items-start md:items-center gap-4 md:gap-10 text-gray-500'>
       ...
       <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guest will be allocated on the ground floor according to availability. 
            you get a comfortable two bedroom apartment has a true city feeling. The price quoted is for two guest,
            at the guest slot please mark the number of guest to get the exact price for groups. 
            The Guest will be allocated ground floor according to availability.
